...
const handleReplyToQuestion = async (req, res) => {
  logger.info('Q&A replyToQuestion called — API discontinued by Google Nov 2025');
  res.status(410).json({
    success: false,
...
module.exports = handleReplyToQuestion;
